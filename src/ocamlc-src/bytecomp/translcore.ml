...
let reset_translcore () =
  transl_module := (fun cc rootpath modl -> assert false);
  transl_object := (fun id s cl -> assert false ) ;
  Hashtbl.clear comparisons_table;
  Hashtbl.clear primitives_table
